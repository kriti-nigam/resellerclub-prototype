...
'      <div class="nav-item' + on('developers') + '"><a href="API &amp; Developer Portal.html">API &amp; Developer Portal</a></div>' +
...
'      <div class="foot-col">' +
'        <h5>Solutions</h5>' +
'        <a href="Platform &amp; API.html">Platform</a><a href="API &amp; Developer Portal.html">API &amp; Dev Portal</a><a href="Who Its For - Web Hosts and Agencies.html">Who it\'s for</a>' +
'      </div>' +
'      <div class="foot-col">' +
'        <h5>Pricing</h5>' +
...
'          </div>' +
'        </div>' +
'        <a href="https://newfold.com/privacy-center" target="_blank">Privacy</a><a href="https://legal.newfold.com/TermsOfUse.pdf" target="_blank">Terms</a><a href="https://resellerclub.com/legal-agreements" target="_blank">Legal</a><a href="https://resellerclub.com/disclosure" target="_blank">Ethical Hacking</a><a href="https://www.newfold.com/privacy-center/addendum-for-california-users" target="_blank">Do Not Sell or Share My Personal Information</a>' +
'      </span>' +
'    </div>' +
'  </div>' +
'</footer>';
