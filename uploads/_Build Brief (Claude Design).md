...
- Primary CTA label "Become a reseller" (to the reseller signup form). Secondary CTA label "Explore the API" (to the Developer Portal). On the Platform & API page only, the page-level CTA order reverses; the header chrome stays the same.
...
- Primary CTA label: Become a reseller. Destination: the reseller signup form.
- Secondary CTA label: Explore the API. Destination: the Developer Portal.
...
- **Primary CTA:** Become a reseller
- **Secondary CTA:** Explore the API
- **Trust micro-line (under CTAs):** 20+ years as a domain reseller platform. 100+ ICANN-accredited registrars on OrderBox.
...
- **Hosting (Oracle Cloud, resell)**
  - Resell hosting to your customers, powered by Oracle Cloud. A wholesale ecosystem product that attaches to the domains you already sell.
